...
const SITE_CONFIG = {
  ...
  noteDuJour: {
    titre: "Note du jour",
    texte: "Aujourd'hui, ça aurait dû être nos deux ans. Je voulais te marquer le coup avec ce site, pour garder une trace durable de ce qu'on a vécu."
  },

  // --- Texte d'ouverture (juste sous le hero) ---
  ouverture: `J'ai voulu créer ce site pour garder une trace 
  de nous deux. Même s'il y a eu des hauts et des bas, 
  je trouve que notre histoire est importante et qu'elle 
  mérite de ne jamais être oubliée.`,
  ...
  raisons: [
    ...
    "Ta famille incroyable que je n'oublierais jamais.",
